...
- Release: `https://github.com/phattrongtran15-pixel/ai-delivery-control-kit/releases/tag/v0.2.1`.
- Public CI: `PASS` on Python 3.10, 3.11, and 3.12 for commit `5978da17f783dac6d50ec4ba78bfd8ed163e3023`.
